...
public class DangNhap {
	...
	private void initialize() {
		...
		btnDangNhap.setIcon(ICon.designIcon(projectPath + "\\icon\\key.png", 10, 10));
		...
		btnHuyBo.setIcon(ICon.designIcon("D:\\Hoc\\DAI HOC\\ki_6\\ttcn\\TBL_QLTRO\\icon\\arrowleft.png", 10, 10));
		...
		lblIconLock.setIcon(ICon.designIcon("D:\\Hoc\\DAI HOC\\ki_6\\ttcn\\TBL_QLTRO\\icon\\lock.png", 40, 40));
