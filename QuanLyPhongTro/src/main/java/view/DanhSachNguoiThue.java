...
public class DanhSachNguoiThue {
	...
	private void initialize(DanhSachNguoiThueController action) {
		...
		btnthemNguoiThue.setIcon(ICon.designIcon("D:\\TTCN\\QuanLyPhongTro\\src\\main\\resources\\icon\\user-add.png",10, 10));
		...
		btnSuaNguoiThue.setIcon(ICon.designIcon("D:\\TTCN\\QuanLyPhongTro\\src\\main\\resources\\icon\\user-pen.png", 10,10));
