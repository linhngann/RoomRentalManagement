...
public class ThemNhaTro extends javax.swing.JFrame {
    ...
    private void thembuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_thembuttonActionPerformed
        nhatro.setMaNhaTro(String.valueOf(maNhaTroTextField.getText()));
        nhatro.setTenNhaTro(String.valueOf(tenTextField.getText()));
        nhatro.setDiaChi(String.valueOf(diachiTextField.getText()));
        nhatro.setSoLuongPhong(Integer.parseInt(String.valueOf(soluongTextField.getText())));
        nhatro.setNgayBatDau(Date.valueOf(ngaybdTextField.getText()));
        String status = "";
        if(ttYRadioButton.isSelected())
        {
            status = "Y";
        }
        if(ttNRadioButton.isSelected())
        {
            status = "N";
        }
        nhatro.setTrangThai(status);
        nhatro.setIdNhanVienQuanLy(Integer.parseInt(idNVQLTextField.getText()));
        ntctl.Insert(nhatro);
