...
public class XemChiTietDichVu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        themDichVuButton.setIcon(new javax.swing.ImageIcon("D:\\Study\\TTCN\\QuanLyPhongTro\\src\\main\\resources\\icon\\back1 (1).png")); // NOI18N
        themDichVuButton.setText("Quay về");
    ...
    private void themDichVuButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themDichVuButtonActionPerformed
        ...
        this.dispose();    }//GEN-LAST:event_themDichVuButtonActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(XemChiTietDichVu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new XemChiTietDichVu().setVisible(true);
            }
        });
    }
